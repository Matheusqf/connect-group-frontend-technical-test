        ...
        >
            <div className={styles['vehicle-details-dialog__header']}>
                ...
                <div className={styles['vehicle-details-dialog__header-info']}>
                    <h1 className={styles['vehicle-details-dialog__title']}>{id}</h1>
            ...
            <div className={styles['vehicle-details-dialog__content']}>
                <p className={styles['vehicle-details-dialog__description']}>{description}</p>
